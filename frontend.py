...
with st.sidebar:
    ...
    available_dimensions = list(describe_metadata_data.keys())
    selected_dimension_1 = st.selectbox("Dimension 1", [None] + available_dimensions)
    selected_dimension_2 = st.selectbox("Dimension 2", [None] + [available_dimension for available_dimension in available_dimensions if available_dimension != selected_dimension_1])
...
if selected_dimension_2 and not selected_dimension_1:
    inputs["dimension_1_name"] = selected_dimension_2
    inputs["dimension_1_values"] = list(describe_metadata_data[selected_dimension_2])
else:
    if selected_dimension_1:
        inputs["dimension_1_name"] = selected_dimension_1
        inputs["dimension_1_values"] = list(describe_metadata_data[selected_dimension_1])
    if selected_dimension_2:
        inputs["dimension_2_name"] = selected_dimension_2
        inputs["dimension_2_values"] = list(describe_metadata_data[selected_dimension_2])
